...
public class Main {
    ...
    private static void main1() throws IOException{
        ...
        Orders orders;
        /* readData from csv */
        dataMatrix = ReadDataFromCSV.readDoubleToMatrix("exNODES.csv");
        truckDistanceMatrix = ReadDataFromCSV.readDoubleToMatrix("Tt.csv");
        Functions.printMatrix(dataMatrix);
        Functions.printMatrix(truckDistanceMatrix);
        
        /* initialize Nodes */
        nodes = new Nodes(dataMatrix);
        Node startnode = new StartEndNode(-1, 0, 0, 's');

        /* initialize Orders(by orderNodeList) */
        //System.out.println("foo" + nodes.NodeList[0].coord[1]);
        //System.out.println("bar" + nodes.orderNodeList[0].orderT);
        ...
        /* initialize vehicle */
        Courier courier = new Courier(0, 10, nodes.NodeList[2]);
        ...
        System.out.println(courier.routeSeq.get(3).id);
    }
